...
namespace Rebus.OldLog4Net
{
    ...
    public static class OldLog4NetLoggingExtension
    {
        ...
        /// </summary>
        public static void OldLog4Net(this LoggingConfigurer configurer)
        {
        ...
        /// </summary>
        public static void OldLog4Net(this LoggingConfigurer configurer, string overriddenCorrelationIdPropertyKey)
        {
            configurer.Use(new Log4NetLoggerFactory());
